			...
			<div class="col-md-7 col-md-offset-3">
				...
				<form name="form_customers" action="update_customers.php?operacio=<?=$operacio?>" role="form" method="post">
                    ...
                    <div class="form-inline">
						...
						<div class="form-group">
							<label class="control-label" for="mail2">@</label>
							<input required type="text" name="mail2" id="mail2" maxlength="50" class="form-control" placeholder="Insert Domain" value="<?php if (isset($row)) echo $row["mail2"]?>"/>
						</div>
					</div>
                    <br>
